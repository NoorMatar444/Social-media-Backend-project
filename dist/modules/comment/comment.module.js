    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                {
                    name: comment_model_1.Comment.name,
        ...
        providers: [token_service_1.TokenService, authentication_guard_1.AuthGuard, comment_sevice_1.CommentService, comment_repo_1.CommentRepo],
